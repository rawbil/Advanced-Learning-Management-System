      ...
      <div className="w-full">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-center my-3 gap-[10%]">
            <span className="cursor-pointer " title="login with google" onClick={()=> signIn("google")}>
              <FcGoogle size={28} />
            </span>
            <span className="cursor-pointer" title="login with github" onClick={() => signIn("github")}>
              <FaGithub size={28} />
            </span>
          </div>
